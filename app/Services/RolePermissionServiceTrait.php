...
trait RolePermissionServiceTrait
{
     ...
     * @inheritDoc
     */
    public function getByUserApiToken(string $apiToken, RolePermissionRepository $rolePermissionRepository, RolePermissionServiceResponse $rolePermissionServiceResponse): RolePermissionServiceResponse
    {
        $rolePermission = app()->call([$rolePermissionRepository, 'getByUserApiToken'], compact('apiToken'));
        return $this->formatResult($rolePermission, $rolePermissionServiceResponse);
    }
     ...
     * @inheritDoc
     */
    public function getByUserApiTokenList(string $apiToken, RolePermissionRepository $rolePermissionRepository, RolePermissionServiceResponseList $rolePermissionServiceResponseList, string $q = null,  int $length = 12): RolePermissionServiceResponseList
    {
        $rolePermission = app()->call([$rolePermissionRepository, 'getByUserApiTokenList'], compact('apiToken', 'length', 'q'));
        return $this->formatResultList($rolePermission, $rolePermissionServiceResponseList);
    }
     ...
     * @inheritDoc
     */
    public function getByUpdatedByUserApiToken(string $apiToken, RolePermissionRepository $rolePermissionRepository, RolePermissionServiceResponse $rolePermissionServiceResponse): RolePermissionServiceResponse
    {
        $rolePermission = app()->call([$rolePermissionRepository, 'getByUpdatedByUserApiToken'], compact('apiToken'));
        return $this->formatResult($rolePermission, $rolePermissionServiceResponse);
    }
     ...
     * @inheritDoc
     */
    public function getByUpdatedByUserApiTokenList(string $apiToken, RolePermissionRepository $rolePermissionRepository, RolePermissionServiceResponseList $rolePermissionServiceResponseList, string $q = null,  int $length = 12): RolePermissionServiceResponseList
    {
        $rolePermission = app()->call([$rolePermissionRepository, 'getByUpdatedByUserApiTokenList'], compact('apiToken', 'length', 'q'));
        return $this->formatResultList($rolePermission, $rolePermissionServiceResponseList);
    }
