 ...
 * Date: 14:04:02
 * Time: 2021/11/06
 * Class AppRouteUpdateController
...
/**
     * @OA\Put(
     *      path="/api/app-route/{name}/update",
     *      tags={"App Route"},
     ...
     *      )
     *
     * Returns App Route Update status
     */
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$appRouteService, 'update'], ['name' => $name, 'appRouteServiceRequest' => $appRouteServiceRequest]);
