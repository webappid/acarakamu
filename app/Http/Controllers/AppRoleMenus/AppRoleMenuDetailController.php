 ...
 * Date: 14:04:00
 * Time: 2021/11/06
 * Class AppRoleMenuDetailController
...
class AppRoleMenuDetailController
{
    ...
    /**
     * @OA\Get(
     *      path="/api/app-role-menu/{id}/detail",
     *      tags={"App Role Menu"},
     *      summary="Get App Role Menu Detail",
     *      description="Returns App Role Menu Detail",
     *      @OA\Parameter(
     *          name="id",
    ...
    public function __invoke(int $id,
                             ...
                             Response $response)
    {
        $result = app()->call([$appRoleMenuService, 'getById'], compact('id'));
