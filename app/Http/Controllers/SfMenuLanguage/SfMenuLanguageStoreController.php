 ...
 * Date: 14:04:42
 * Time: 2021/11/06
 * Class SfMenuLanguageStoreController
...
/**
     * @OA\Post(
     *      path="/api/sf-menu-language/store",
     ...
     *      )
     *
     * Returns Sf Menu Language Store status
     */
    /**
     * @param SfMenuLanguageRequest $sfMenuLanguageRequest
     * @param SfMenuLanguageServiceRequest $sfMenuLanguageServiceRequest
     * @param SfMenuLanguageService $sfMenuLanguageService
     * @param SmartResponse $smartResponse
     * @param Response $response
     * @return mixed
     * @throws Exception
     */
    public function __invoke(SfMenuLanguageRequest $sfMenuLanguageRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$sfMenuLanguageService, 'store'], ['sfMenuLanguageServiceRequest' => $sfMenuLanguageServiceRequest]);
