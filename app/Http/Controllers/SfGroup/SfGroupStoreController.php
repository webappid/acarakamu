...
/**
     ...
     *      )
     *
     * Returns Sf Group Store status
     */
    /**
     * @param SfGroupRequest $sfGroupRequest
     * @param SfGroupServiceRequest $sfGroupServiceRequest
     ...
     * @throws Exception
     */
    public function __invoke(SfGroupRequest $sfGroupRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$sfGroupService, 'store'], ['sfGroupServiceRequest' => $sfGroupServiceRequest]);
