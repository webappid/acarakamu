...
/**
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$imageService, 'update'], ['imageId' => $imageId, 'imageServiceRequest' => $imageServiceRequest]);
        ...
        if ($result->status) {
            ...
            if (!request()->wantsJson()) {
                $response->setRedirect(route('lazy.image.edit', array_merge(['imageId' => $imageId], request()->query->all())));
            }
