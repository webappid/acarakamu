...
/**
     ...
     *      )
     *
     * Returns Font Icon Store status
     */
    /**
     * @param FontIconRequest $fontIconRequest
     * @param FontIconServiceRequest $fontIconServiceRequest
     ...
     * @throws Exception
     */
    public function __invoke(FontIconRequest $fontIconRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$fontIconService, 'store'], ['fontIconServiceRequest' => $fontIconServiceRequest]);
