...
/**
     ...
     *      )
     *
     * Returns Sf Config Store status
     */
    /**
     * @param SfConfigRequest $sfConfigRequest
     * @param SfConfigServiceRequest $sfConfigServiceRequest
     ...
     * @throws Exception
     */
    public function __invoke(SfConfigRequest $sfConfigRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$sfConfigService, 'store'], ['sfConfigServiceRequest' => $sfConfigServiceRequest]);
