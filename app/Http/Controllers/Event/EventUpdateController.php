...
/**
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$eventService, 'update'], ['eventId' => $eventId, 'eventServiceRequest' => $eventServiceRequest]);
        ...
        if ($result->status) {
            ...
            if (!request()->wantsJson()) {
                $response->setRedirect(route('lazy.event.edit', array_merge(['eventId' => $eventId], request()->query->all())));
            }
