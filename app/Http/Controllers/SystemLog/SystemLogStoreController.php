 ...
 * Date: 14:04:56
 * Time: 2021/11/06
 * Class SystemLogStoreController
...
/**
     ...
     *      )
     *
     * Returns System Log Store status
     */
    /**
     * @param SystemLogRequest $systemLogRequest
     * @param SystemLogServiceRequest $systemLogServiceRequest
     ...
     * @throws Exception
     */
    public function __invoke(SystemLogRequest $systemLogRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$systemLogService, 'store'], ['systemLogServiceRequest' => $systemLogServiceRequest]);
