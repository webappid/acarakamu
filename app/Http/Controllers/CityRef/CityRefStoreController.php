...
/**
     ...
     *      )
     *
     * Returns City Ref Store status
     */
    /**
     * @param CityRefRequest $cityRefRequest
     * @param CityRefServiceRequest $cityRefServiceRequest
     ...
     * @throws Exception
     */
    public function __invoke(CityRefRequest $cityRefRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$cityRefService, 'store'], ['cityRefServiceRequest' => $cityRefServiceRequest]);
