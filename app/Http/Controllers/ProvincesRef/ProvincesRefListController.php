 ...
 * Date: 14:04:29
 * Time: 2021/11/06
 * Class ProvincesRefListController
...
class ProvincesRefListController
{
     ...
     */
    /**
     * @param ProvincesRefSearchRequest $provincesRefSearchRequest
    ...
    public function __invoke(
                             ProvincesRefSearchRequest $provincesRefSearchRequest,
                             ProvincesRefService $provincesRefService,
                             SmartResponse $smartResponse,
                             Response $response)
    {
        $searchValue = $provincesRefSearchRequest->validated();
        $q = "";
        ...
        $result = app()->call([$provincesRefService, 'get'], ['q' => $q]);

        $data = [];
        if($result->status){
            foreach ($result->provincesRefList as $item) {
                    $data[] = Lazy::transform($item, new ProvincesRefResponse());
                }
        }
