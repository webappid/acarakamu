 ...
 * Date: 16:04:19
 * Time: 2022/09/14
 * Class ProvincesRefUpdateController
...
/**
     * @OA\Put(
     *      path="/api/provinces-ref/{provincesRefId}/update",
     *      tags={"Provinces Ref"},
     ...
     *      )
     *
     * Returns Provinces Ref Update status
     */

    public function __invoke(int $provincesRefId,
                             ProvincesRefRequest $provincesRefRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$provincesRefService, 'update'], ['provincesRefId' => $provincesRefId, 'provincesRefServiceRequest' => $provincesRefServiceRequest]);
        ...
        if ($result->status) {
            ...
            if (!request()->wantsJson()) {
                $response->setRedirect(route('lazy.provinces-ref.edit', array_merge(['provincesRefId' => $provincesRefId], request()->query->all())));
            }
