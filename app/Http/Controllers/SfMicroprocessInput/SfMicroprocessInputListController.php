 ...
 * Date: 14:04:45
 * Time: 2021/11/06
 * Class SfMicroprocessInputListController
...
class SfMicroprocessInputListController
{
     ...
     */
    /**
     * @param SfMicroprocessInputSearchRequest $sfMicroprocessInputSearchRequest
    ...
    public function __invoke(
                             SfMicroprocessInputSearchRequest $sfMicroprocessInputSearchRequest,
                             SfMicroprocessInputService $sfMicroprocessInputService,
                             SmartResponse $smartResponse,
                             Response $response)
    {
        $searchValue = $sfMicroprocessInputSearchRequest->validated();
        $q = "";
        ...
        $result = app()->call([$sfMicroprocessInputService, 'get'], ['q' => $q]);

        $data = [];
        if($result->status){
            foreach ($result->sfMicroprocessInputList as $item) {
                    $data[] = Lazy::transform($item, new SfMicroprocessInputResponse());
                }
        }
