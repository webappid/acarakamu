 ...
 * Date: 14:04:44
 * Time: 2021/11/06
 * Class SfMicroprocessInputStoreController
...
/**
     * @OA\Post(
     *      path="/api/sf-microprocess-input/store",
     ...
     *      )
     *
     * Returns Sf Microprocess Input Store status
     */
    /**
     * @param SfMicroprocessInputRequest $sfMicroprocessInputRequest
     * @param SfMicroprocessInputServiceRequest $sfMicroprocessInputServiceRequest
     * @param SfMicroprocessInputService $sfMicroprocessInputService
     * @param SmartResponse $smartResponse
     * @param Response $response
     * @return mixed
     * @throws Exception
     */
    public function __invoke(SfMicroprocessInputRequest $sfMicroprocessInputRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$sfMicroprocessInputService, 'store'], ['sfMicroprocessInputServiceRequest' => $sfMicroprocessInputServiceRequest]);
