 ...
 * Date: 14:03:58
 * Time: 2021/11/06
 * Class AppMenuCategoryMenuStoreController
...
/**
     * @OA\Post(
     *      path="/api/app-menu-category-menu/store",
     ...
     *      )
     *
     * Returns App Menu Category Menu Store status
     */
    /**
     * @param AppMenuCategoryMenuRequest $appMenuCategoryMenuRequest
     * @param AppMenuCategoryMenuServiceRequest $appMenuCategoryMenuServiceRequest
     ...
     * @throws Exception
     */
    public function __invoke(AppMenuCategoryMenuRequest $appMenuCategoryMenuRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$appMenuCategoryMenuService, 'store'], ['appMenuCategoryMenuServiceRequest' => $appMenuCategoryMenuServiceRequest]);
