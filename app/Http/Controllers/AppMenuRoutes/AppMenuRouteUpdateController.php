 ...
 * Date: 14:03:59
 * Time: 2021/11/06
 * Class AppMenuRouteUpdateController
...
/**
     * @OA\Put(
     *      path="/api/app-menu-route/{id}/update",
     *      tags={"App Menu Route"},
     ...
     *      )
     *
     * Returns App Menu Route Update status
     */

    public function __invoke(int $id,
                             AppMenuRouteRequest $appMenuRouteRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$appMenuRouteService, 'update'], ['id' => $id, 'appMenuRouteServiceRequest' => $appMenuRouteServiceRequest]);
