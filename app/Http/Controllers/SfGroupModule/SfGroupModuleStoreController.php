 ...
 * Date: 14:04:37
 * Time: 2021/11/06
 * Class SfGroupModuleStoreController
...
/**
     * @OA\Post(
     *      path="/api/sf-group-module/store",
     ...
     *      )
     *
     * Returns Sf Group Module Store status
     */
    /**
     * @param SfGroupModuleRequest $sfGroupModuleRequest
     * @param SfGroupModuleServiceRequest $sfGroupModuleServiceRequest
     * @param SfGroupModuleService $sfGroupModuleService
     * @param SmartResponse $smartResponse
     * @param Response $response
     * @return mixed
     * @throws Exception
     */
    public function __invoke(SfGroupModuleRequest $sfGroupModuleRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$sfGroupModuleService, 'store'], ['sfGroupModuleServiceRequest' => $sfGroupModuleServiceRequest]);
