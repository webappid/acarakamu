 ...
 * Date: 14:04:58
 * Time: 2021/11/06
 * Class UserActivityUpdateController
...
/**
     * @OA\Put(
     *      path="/api/user-activity/{id}/update",
     *      tags={"User Activity"},
     ...
     *      )
     *
     * Returns User Activity Update status
     */
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$userActivityService, 'update'], ['id' => $id, 'userActivityServiceRequest' => $userActivityServiceRequest]);
