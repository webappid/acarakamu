 ...
 * Date: 14:04:58
 * Time: 2021/11/06
 * Class UserActivityDetailController
...
class UserActivityDetailController
{
    ...
    /**
     * @OA\Get(
     *      path="/api/user-activity/{id}/detail",
     *      tags={"User Activity"},
     *      summary="Get User Activity Detail",
     *      description="Returns User Activity Detail",
     *      @OA\Parameter(
     *          name="id",
    ...
    public function __invoke(int $id,
                             ...
                             Response $response)
    {
        $result = app()->call([$userActivityService, 'getById'], compact('id'));
