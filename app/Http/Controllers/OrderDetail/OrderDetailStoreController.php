 ...
 * Date: 16:04:14
 * Time: 2022/09/14
 * Class OrderDetailStoreController
...
/**
     ...
     *      )
     *
     * Returns Order Detail Store status
     */
    public function __invoke(OrderDetailRequest $orderDetailRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$orderDetailService, 'store'], ['orderDetailServiceRequest' => $orderDetailServiceRequest]);
        ...
        if ($result->status) {
            ...
            if (!request()->wantsJson()) {
                $response->setRedirect(route('lazy.order-detail.create', request()->query->all()));
            }
