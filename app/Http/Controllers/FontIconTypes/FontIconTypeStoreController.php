 ...
 * Date: 14:04:13
 * Time: 2021/11/06
 * Class FontIconTypeStoreController
...
/**
     * @OA\Post(
     *      path="/api/font-icon-type/store",
     *      tags={"Font Icon Type"},
     *      summary="Store Font Icon Type Data",
     *      description="Store Font Icon Type Data",
     *      @OA\Parameter(
     *          name="name",
     *          in="query",
     *          required=true,
     *          description="FontIconType name",
     *          @OA\Schema(
     *              type="string"
     *          )
     *      ),
     ...
     *      )
     *
     * Returns Font Icon Type Store status
     */
    /**
     * @param FontIconTypeRequest $fontIconTypeRequest
     * @param FontIconTypeServiceRequest $fontIconTypeServiceRequest
     ...
     * @throws Exception
     */
    public function __invoke(FontIconTypeRequest $fontIconTypeRequest,
                             FontIconTypeServiceRequest $fontIconTypeServiceRequest,
                             FontIconTypeService $fontIconTypeService,
                             FontIconTypeResponse $fontIconTypeResponse,
                             SmartResponse $smartResponse,
                             Response $response)
    {
        $fontIconTypeValidated = $fontIconTypeRequest->validated();

        $fontIconTypeServiceRequest = Lazy::copyFromArray($fontIconTypeValidated, $fontIconTypeServiceRequest, Lazy::AUTOCAST);

        
        
        $result = app()->call([$fontIconTypeService, 'store'], ['fontIconTypeServiceRequest' => $fontIconTypeServiceRequest]);
