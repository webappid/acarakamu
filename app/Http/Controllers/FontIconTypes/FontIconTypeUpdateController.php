 ...
 * Date: 14:04:13
 * Time: 2021/11/06
 * Class FontIconTypeUpdateController
...
/**
     * @OA\Put(
     *      path="/api/font-icon-type/{name}/update",
     *      tags={"Font Icon Type"},
     ...
     *      )
     *
     * Returns Font Icon Type Update status
     */

    public function __invoke(string $name,
                             FontIconTypeRequest $fontIconTypeRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$fontIconTypeService, 'update'], ['name' => $name, 'fontIconTypeServiceRequest' => $fontIconTypeServiceRequest]);
