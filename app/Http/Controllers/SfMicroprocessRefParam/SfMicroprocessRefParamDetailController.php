 ...
 * Date: 14:04:47
 * Time: 2021/11/06
 * Class SfMicroprocessRefParamDetailController
...
class SfMicroprocessRefParamDetailController
{
    ...
    /**
     * @OA\Get(
     *      path="/api/sf-microprocess-ref-param/{paramName}/detail",
     *      tags={"Sf Microprocess Ref Param"},
     *      summary="Get Sf Microprocess Ref Param Detail",
     *      description="Returns Sf Microprocess Ref Param Detail",
     *      @OA\Parameter(
     *          name="paramName",
     ...
     *      )
     *
     * Returns Sf Microprocess Ref Param Detail
     */
    ...
    public function __invoke(string $paramName,
                             ...
                             Response $response)
    {
        $result = app()->call([$sfMicroprocessRefParamService, 'getByParamName'], compact('paramName'));
