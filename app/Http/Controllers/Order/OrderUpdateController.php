...
/**
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$orderService, 'update'], ['orderId' => $orderId, 'orderServiceRequest' => $orderServiceRequest]);
        ...
        if ($result->status) {
            ...
            if (!request()->wantsJson()) {
                $response->setRedirect(route('lazy.order.edit', array_merge(['orderId' => $orderId], request()->query->all())));
            }
