 ...
 * Date: 16:04:12
 * Time: 2022/09/14
 * Class MigrationUpdateController
...
/**
     ...
     *      )
     *
     * Returns Migration Update status
     */
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$migrationService, 'update'], ['id' => $id, 'migrationServiceRequest' => $migrationServiceRequest]);
        ...
        if ($result->status) {
            ...
            if (!request()->wantsJson()) {
                $response->setRedirect(route('lazy.migration.edit', array_merge(['id' => $id], request()->query->all())));
            }
