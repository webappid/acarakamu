 ...
 * Date: 16:04:23
 * Time: 2022/09/14
 * Class SfAccessRefDetailController
...
class SfAccessRefDetailController
{
    ...
    /**
     * @OA\Get(
     *      path="/api/sf-access-ref/{accessId}/detail",
     *      tags={"Sf Access Ref"},
     *      summary="Get Sf Access Ref Detail",
     *      description="Returns Sf Access Ref Detail",
     *      @OA\Parameter(
     *          name="accessId",
    ...
    public function __invoke(int $accessId,
                             ...
                             Response $response)
    {
        $result = app()->call([$sfAccessRefService, 'getByAccessId'], compact('accessId'));
