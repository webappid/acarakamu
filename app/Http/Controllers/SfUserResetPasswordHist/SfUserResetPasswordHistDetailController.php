 ...
 * Date: 14:04:54
 * Time: 2021/11/06
 * Class SfUserResetPasswordHistDetailController
...
class SfUserResetPasswordHistDetailController
{
    ...
    /**
     * @OA\Get(
     *      path="/api/sf-user-reset-password-hist/{userResetPasswordHistId}/detail",
     *      tags={"Sf User Reset Password Hist"},
     *      summary="Get Sf User Reset Password Hist Detail",
     *      description="Returns Sf User Reset Password Hist Detail",
     *      @OA\Parameter(
     ...
     *      )
     *
     * Returns Sf User Reset Password Hist Detail
     */

    /**
     * @param int $userResetPasswordHistId
    ...
    public function __invoke(int $userResetPasswordHistId,
                             ...
                             Response $response)
    {
        $result = app()->call([$sfUserResetPasswordHistService, 'getByUserResetPasswordHistId'], compact('userResetPasswordHistId'));
