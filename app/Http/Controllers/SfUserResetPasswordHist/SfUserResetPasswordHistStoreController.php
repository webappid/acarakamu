 ...
 * Date: 14:04:54
 * Time: 2021/11/06
 * Class SfUserResetPasswordHistStoreController
...
/**
     * @OA\Post(
     *      path="/api/sf-user-reset-password-hist/store",
     ...
     *      )
     *
     * Returns Sf User Reset Password Hist Store status
     */
    /**
     * @param SfUserResetPasswordHistRequest $sfUserResetPasswordHistRequest
     * @param SfUserResetPasswordHistServiceRequest $sfUserResetPasswordHistServiceRequest
     ...
     * @throws Exception
     */
    public function __invoke(SfUserResetPasswordHistRequest $sfUserResetPasswordHistRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$sfUserResetPasswordHistService, 'store'], ['sfUserResetPasswordHistServiceRequest' => $sfUserResetPasswordHistServiceRequest]);
