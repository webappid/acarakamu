...
class SfMenuDetailController
{
    ...
    /**
     * @OA\Get(
     *      path="/api/sf-menu/{menuId}/detail",
     *      tags={"Sf Menu"},
     *      summary="Get Sf Menu Detail",
     *      description="Returns Sf Menu Detail",
     *      @OA\Parameter(
     *          name="menuId",
    ...
    public function __invoke(int $menuId,
                             ...
                             Response $response)
    {
        $result = app()->call([$sfMenuService, 'getByMenuId'], compact('menuId'));
