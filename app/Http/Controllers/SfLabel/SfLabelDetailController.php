...
class SfLabelDetailController
{
    ...
    /**
     * @OA\Get(
     *      path="/api/sf-label/{labelId}/detail",
     *      tags={"Sf Label"},
     *      summary="Get Sf Label Detail",
     *      description="Returns Sf Label Detail",
     *      @OA\Parameter(
     *          name="labelId",
    ...
    public function __invoke(int $labelId,
                             ...
                             Response $response)
    {
        $result = app()->call([$sfLabelService, 'getByLabelId'], compact('labelId'));
