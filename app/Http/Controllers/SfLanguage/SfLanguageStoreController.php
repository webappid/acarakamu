 ...
 * Date: 14:04:39
 * Time: 2021/11/06
 * Class SfLanguageStoreController
...
/**
     ...
     *      )
     *
     * Returns Sf Language Store status
     */
    /**
     * @param SfLanguageRequest $sfLanguageRequest
     * @param SfLanguageServiceRequest $sfLanguageServiceRequest
     ...
     * @throws Exception
     */
    public function __invoke(SfLanguageRequest $sfLanguageRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$sfLanguageService, 'store'], ['sfLanguageServiceRequest' => $sfLanguageServiceRequest]);
