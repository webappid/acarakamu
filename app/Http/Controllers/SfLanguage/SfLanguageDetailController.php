 ...
 * Date: 14:04:39
 * Time: 2021/11/06
 * Class SfLanguageDetailController
...
class SfLanguageDetailController
{
    ...
    /**
     * @OA\Get(
     *      path="/api/sf-language/{languageId}/detail",
     *      tags={"Sf Language"},
     *      summary="Get Sf Language Detail",
     *      description="Returns Sf Language Detail",
     *      @OA\Parameter(
     *          name="languageId",
    ...
    public function __invoke(int $languageId,
                             ...
                             Response $response)
    {
        $result = app()->call([$sfLanguageService, 'getByLanguageId'], compact('languageId'));
