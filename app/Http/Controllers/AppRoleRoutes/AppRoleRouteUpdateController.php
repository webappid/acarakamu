 ...
 * Date: 14:04:01
 * Time: 2021/11/06
 * Class AppRoleRouteUpdateController
...
/**
     * @OA\Put(
     *      path="/api/app-role-route/{id}/update",
     *      tags={"App Role Route"},
     ...
     *      )
     *
     * Returns App Role Route Update status
     */

    public function __invoke(int $id,
                             AppRoleRouteRequest $appRoleRouteRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$appRoleRouteService, 'update'], ['id' => $id, 'appRoleRouteServiceRequest' => $appRoleRouteServiceRequest]);
