...
class SfUserDetailController
{
    ...
    /**
     * @OA\Get(
     *      path="/api/sf-user/{userName}/detail",
     *      tags={"Sf User"},
     *      summary="Get Sf User Detail",
     *      description="Returns Sf User Detail",
     *      @OA\Parameter(
     *          name="userName",
    ...
    public function __invoke(string $userName,
                             ...
                             Response $response)
    {
        $result = app()->call([$sfUserService, 'getByUserName'], compact('userName'));
