...
/**
     ...
     *      )
     *
     * Returns Sf User Store status
     */
    public function __invoke(SfUserRequest $sfUserRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$sfUserService, 'store'], ['sfUserServiceRequest' => $sfUserServiceRequest]);
        ...
        if ($result->status) {
            ...
            if (!request()->wantsJson()) {
                $response->setRedirect(route('lazy.sf-user.create', request()->query->all()));
            }
