 ...
 * Date: 16:04:36
 * Time: 2022/09/14
 * Class SfMicroprocessProcessDetailController
...
class SfMicroprocessProcessDetailController
{
    ...
    /**
     * @OA\Get(
     *      path="/api/sf-microprocess-process/{microprocessProcessId}/detail",
     *      tags={"Sf Microprocess Process"},
     *      summary="Get Sf Microprocess Process Detail",
     *      description="Returns Sf Microprocess Process Detail",
     *      @OA\Parameter(
     ...
     *      )
     *
     * Returns Sf Microprocess Process Detail
     */
    public function __invoke(int $microprocessProcessId,
                             ...
                             Response $response)
    {
        $result = app()->call([$sfMicroprocessProcessService, 'getByMicroprocessProcessId'], compact('microprocessProcessId'));
