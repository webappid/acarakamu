 ...
 * Date: 16:04:36
 * Time: 2022/09/14
 * Class SfMicroprocessProcessStoreController
...
/**
     * @OA\Post(
     *      path="/api/sf-microprocess-process/store",
     ...
     *      )
     *
     * Returns Sf Microprocess Process Store status
     */
    public function __invoke(SfMicroprocessProcessRequest $sfMicroprocessProcessRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$sfMicroprocessProcessService, 'store'], ['sfMicroprocessProcessServiceRequest' => $sfMicroprocessProcessServiceRequest]);
        ...
        if ($result->status) {
            ...
            if (!request()->wantsJson()) {
                $response->setRedirect(route('lazy.sf-microprocess-process.create', request()->query->all()));
            }
