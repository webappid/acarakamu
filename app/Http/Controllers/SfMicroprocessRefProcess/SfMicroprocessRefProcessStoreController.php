 ...
 * Date: 14:04:49
 * Time: 2021/11/06
 * Class SfMicroprocessRefProcessStoreController
...
/**
     * @OA\Post(
     *      path="/api/sf-microprocess-ref-process/store",
     *      tags={"Sf Microprocess Ref Process"},
     *      summary="Store Sf Microprocess Ref Process Data",
     *      description="Store Sf Microprocess Ref Process Data",
     *      @OA\Parameter(
     *          name="processCode",
     *          in="query",
     *          required=true,
     *          description="SfMicroprocessRefProcess processCode",
     *          @OA\Schema(
     *              type="string"
     *          )
     *      ),
     ...
     *          in="query",
     *          required=true,
     *          description="SfMicroprocessRefProcess processDesc",
     *          @OA\Schema(
     *              type="string"
     *          )
     *      ),
     ...
     *          in="query",
     *          required=false,
     *          description="SfMicroprocessRefProcess processProcess",
     *          @OA\Schema(
     *              type="string"
     *          )
     *      ),
     ...
     *          in="query",
     *          required=true,
     *          description="SfMicroprocessRefProcess processMethod",
     *          @OA\Schema(
     *              type="string"
     *          )
     *      ),
     *      @OA\Parameter(
     *          name="processResultParamId",
     *          in="query",
     *          required=false,
     *          description="SfMicroprocessRefProcess processResultParamId",
     *          @OA\Schema(
     *              type="int"
     *          )
     *      ),
     ...
     *          in="query",
     *          required=true,
     *          description="SfMicroprocessRefProcess processType",
     *          @OA\Schema(
     *              type="string"
     *          )
     *      ),
     ...
     *      )
     *
     * Returns Sf Microprocess Ref Process Store status
     */
    /**
     * @param SfMicroprocessRefProcessRequest $sfMicroprocessRefProcessRequest
     * @param SfMicroprocessRefProcessServiceRequest $sfMicroprocessRefProcessServiceRequest
     * @param SfMicroprocessRefProcessService $sfMicroprocessRefProcessService
     * @param SmartResponse $smartResponse
     * @param Response $response
     * @return mixed
     * @throws Exception
     */
    public function __invoke(SfMicroprocessRefProcessRequest $sfMicroprocessRefProcessRequest,
                             SfMicroprocessRefProcessServiceRequest $sfMicroprocessRefProcessServiceRequest,
                             ...
                             Response $response)
    {
        $sfMicroprocessRefProcessValidated = $sfMicroprocessRefProcessRequest->validated();

        $sfMicroprocessRefProcessServiceRequest = Lazy::copyFromArray($sfMicroprocessRefProcessValidated, $sfMicroprocessRefProcessServiceRequest, Lazy::AUTOCAST);

        
        
        $result = app()->call([$sfMicroprocessRefProcessService, 'store'], ['sfMicroprocessRefProcessServiceRequest' => $sfMicroprocessRefProcessServiceRequest]);
