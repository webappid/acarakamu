 ...
 * Date: 14:04:43
 * Time: 2021/11/06
 * Class SfMicroprocessDetailController
...
class SfMicroprocessDetailController
{
    ...
    /**
     * @OA\Get(
     *      path="/api/sf-microprocess/{microprocessCode}/detail",
     *      tags={"Sf Microprocess"},
     *      summary="Get Sf Microprocess Detail",
     *      description="Returns Sf Microprocess Detail",
     *      @OA\Parameter(
     ...
     *      )
     *
     * Returns Sf Microprocess Detail
     */

    /**
     * @param string $microprocessCode
    ...
    public function __invoke(string $microprocessCode,
                             ...
                             Response $response)
    {
        $result = app()->call([$sfMicroprocessService, 'getByMicroprocessCode'], compact('microprocessCode'));
