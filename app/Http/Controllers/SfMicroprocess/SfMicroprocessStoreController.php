 ...
 * Date: 14:04:43
 * Time: 2021/11/06
 * Class SfMicroprocessStoreController
...
/**
     * @OA\Post(
     *      path="/api/sf-microprocess/store",
     ...
     *      )
     *
     * Returns Sf Microprocess Store status
     */
    /**
     * @param SfMicroprocessRequest $sfMicroprocessRequest
     * @param SfMicroprocessServiceRequest $sfMicroprocessServiceRequest
     ...
     * @throws Exception
     */
    public function __invoke(SfMicroprocessRequest $sfMicroprocessRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$sfMicroprocessService, 'store'], ['sfMicroprocessServiceRequest' => $sfMicroprocessServiceRequest]);
