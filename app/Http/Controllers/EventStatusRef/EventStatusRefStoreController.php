...
/**
     ...
     */
    /**
     * @param EventStatusRefRequest $eventStatusRefRequest
     * @param EventStatusRefServiceRequest $eventStatusRefServiceRequest
     * @param EventStatusRefService $eventStatusRefService
