...
/**
     ...
     *      )
     *
     * Returns Permission Update status
     */
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$permissionService, 'update'], ['id' => $id, 'permissionServiceRequest' => $permissionServiceRequest]);
        ...
        if ($result->status) {
            ...
            if (!request()->wantsJson()) {
                $response->setRedirect(route('lazy.permission.edit', array_merge(['id' => $id], request()->query->all())));
            }
