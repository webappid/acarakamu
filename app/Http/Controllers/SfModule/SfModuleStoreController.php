...
/**
     ...
     *      )
     *
     * Returns Sf Module Store status
     */
    /**
     * @param SfModuleRequest $sfModuleRequest
     * @param SfModuleServiceRequest $sfModuleServiceRequest
     ...
     * @throws Exception
     */
    public function __invoke(SfModuleRequest $sfModuleRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$sfModuleService, 'store'], ['sfModuleServiceRequest' => $sfModuleServiceRequest]);
