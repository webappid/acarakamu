 ...
 * Date: 14:04:50
 * Time: 2021/11/06
 * Class SfModuleDetailController
...
class SfModuleDetailController
{
    ...
    /**
     * @OA\Get(
     *      path="/api/sf-module/{moduleCode}/detail",
     *      tags={"Sf Module"},
     *      summary="Get Sf Module Detail",
     *      description="Returns Sf Module Detail",
     *      @OA\Parameter(
     *          name="moduleCode",
    ...
    public function __invoke(string $moduleCode,
                             ...
                             Response $response)
    {
        $result = app()->call([$sfModuleService, 'getByModuleCode'], compact('moduleCode'));
