 ...
 * Date: 16:04:21
 * Time: 2022/09/14
 * Class RoleRouteDetailController
...
class RoleRouteDetailController
{
    ...
    /**
     * @OA\Get(
     *      path="/api/role-route/{id}/detail",
     *      tags={"Role Route"},
     *      summary="Get Role Route Detail",
     *      description="Returns Role Route Detail",
     *      @OA\Parameter(
     *          name="id",
    ...
    public function __invoke(int $id,
                             ...
                             Response $response)
    {
        $result = app()->call([$roleRouteService, 'getById'], compact('id'));
