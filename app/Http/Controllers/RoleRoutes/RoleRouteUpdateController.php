 ...
 * Date: 16:04:21
 * Time: 2022/09/14
 * Class RoleRouteUpdateController
...
/**
     ...
     *      )
     *
     * Returns Role Route Update status
     */

    public function __invoke(int $id,
                             RoleRouteRequest $roleRouteRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$roleRouteService, 'update'], ['id' => $id, 'roleRouteServiceRequest' => $roleRouteServiceRequest]);
        ...
        if ($result->status) {
            ...
            if (!request()->wantsJson()) {
                $response->setRedirect(route('lazy.role-route.edit', array_merge(['id' => $id], request()->query->all())));
            }
