 ...
 * Date: 14:04:23
 * Time: 2021/11/06
 * Class OrderHistoryStatusDetailController
...
class OrderHistoryStatusDetailController
{
    ...
    /**
     * @OA\Get(
     *      path="/api/order-history-status/{orderHistoryStatusId}/detail",
     *      tags={"Order History Status"},
     *      summary="Get Order History Status Detail",
     *      description="Returns Order History Status Detail",
     *      @OA\Parameter(
     ...
     *      )
     *
     * Returns Order History Status Detail
     */

    /**
     * @param int $orderHistoryStatusId
    ...
    public function __invoke(int $orderHistoryStatusId,
                             ...
                             Response $response)
    {
        $result = app()->call([$orderHistoryStatusService, 'getByOrderHistoryStatusId'], compact('orderHistoryStatusId'));
