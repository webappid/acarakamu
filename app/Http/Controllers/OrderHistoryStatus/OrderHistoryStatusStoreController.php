 ...
 * Date: 14:04:23
 * Time: 2021/11/06
 * Class OrderHistoryStatusStoreController
...
/**
     * @OA\Post(
     *      path="/api/order-history-status/store",
     ...
     *      )
     *
     * Returns Order History Status Store status
     */
    /**
     * @param OrderHistoryStatusRequest $orderHistoryStatusRequest
     * @param OrderHistoryStatusServiceRequest $orderHistoryStatusServiceRequest
     * @param OrderHistoryStatusService $orderHistoryStatusService
     * @param SmartResponse $smartResponse
     * @param Response $response
     * @return mixed
     * @throws Exception
     */
    public function __invoke(OrderHistoryStatusRequest $orderHistoryStatusRequest,
                             ...
                             Response $response)
    {
        ...
        $result = app()->call([$orderHistoryStatusService, 'store'], ['orderHistoryStatusServiceRequest' => $orderHistoryStatusServiceRequest]);
