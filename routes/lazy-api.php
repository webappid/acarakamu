...
Route::get('/app-menu-category/{name}/detail', App\Http\Controllers\AppMenuCategories\AppMenuCategoryDetailController::class)->name('lazy.app-menu-categories.detail');

Route::post('/app-menu-category/store', App\Http\Controllers\AppMenuCategories\AppMenuCategoryStoreController::class)->name('lazy.app-menu-categories.store');

Route::get('/app-menu-category/list', App\Http\Controllers\AppMenuCategories\AppMenuCategoryListController::class)->name('lazy.app-menu-categories.list');

Route::delete('/app-menu-category/{name}/delete', App\Http\Controllers\AppMenuCategories\AppMenuCategoryDeleteController::class)->name('lazy.app-menu-categories.delete');

Route::put('/app-menu-category/{name}/update', App\Http\Controllers\AppMenuCategories\AppMenuCategoryUpdateController::class)->name('lazy.app-menu-categories.update');

Route::get('/app-menu-category-menu/{id}/detail', App\Http\Controllers\AppMenuCategoryMenus\AppMenuCategoryMenuDetailController::class)->name('lazy.app-menu-category-menus.detail');

Route::post('/app-menu-category-menu/store', App\Http\Controllers\AppMenuCategoryMenus\AppMenuCategoryMenuStoreController::class)->name('lazy.app-menu-category-menus.store');

Route::get('/app-menu-category-menu/list', App\Http\Controllers\AppMenuCategoryMenus\AppMenuCategoryMenuListController::class)->name('lazy.app-menu-category-menus.list');

Route::delete('/app-menu-category-menu/{id}/delete', App\Http\Controllers\AppMenuCategoryMenus\AppMenuCategoryMenuDeleteController::class)->name('lazy.app-menu-category-menus.delete');

Route::put('/app-menu-category-menu/{id}/update', App\Http\Controllers\AppMenuCategoryMenus\AppMenuCategoryMenuUpdateController::class)->name('lazy.app-menu-category-menus.update');

Route::get('/app-menu-route/{id}/detail', App\Http\Controllers\AppMenuRoutes\AppMenuRouteDetailController::class)->name('lazy.app-menu-routes.detail');

Route::post('/app-menu-route/store', App\Http\Controllers\AppMenuRoutes\AppMenuRouteStoreController::class)->name('lazy.app-menu-routes.store');

Route::get('/app-menu-route/list', App\Http\Controllers\AppMenuRoutes\AppMenuRouteListController::class)->name('lazy.app-menu-routes.list');

Route::delete('/app-menu-route/{id}/delete', App\Http\Controllers\AppMenuRoutes\AppMenuRouteDeleteController::class)->name('lazy.app-menu-routes.delete');

Route::put('/app-menu-route/{id}/update', App\Http\Controllers\AppMenuRoutes\AppMenuRouteUpdateController::class)->name('lazy.app-menu-routes.update');

Route::get('/app-menu/{name}/detail', App\Http\Controllers\AppMenus\AppMenuDetailController::class)->name('lazy.app-menus.detail');

Route::post('/app-menu/store', App\Http\Controllers\AppMenus\AppMenuStoreController::class)->name('lazy.app-menus.store');

Route::get('/app-menu/list', App\Http\Controllers\AppMenus\AppMenuListController::class)->name('lazy.app-menus.list');

Route::delete('/app-menu/{name}/delete', App\Http\Controllers\AppMenus\AppMenuDeleteController::class)->name('lazy.app-menus.delete');

Route::put('/app-menu/{name}/update', App\Http\Controllers\AppMenus\AppMenuUpdateController::class)->name('lazy.app-menus.update');

Route::get('/app-role-menu/{id}/detail', App\Http\Controllers\AppRoleMenus\AppRoleMenuDetailController::class)->name('lazy.app-role-menus.detail');

Route::post('/app-role-menu/store', App\Http\Controllers\AppRoleMenus\AppRoleMenuStoreController::class)->name('lazy.app-role-menus.store');

Route::get('/app-role-menu/list', App\Http\Controllers\AppRoleMenus\AppRoleMenuListController::class)->name('lazy.app-role-menus.list');

Route::delete('/app-role-menu/{id}/delete', App\Http\Controllers\AppRoleMenus\AppRoleMenuDeleteController::class)->name('lazy.app-role-menus.delete');

Route::put('/app-role-menu/{id}/update', App\Http\Controllers\AppRoleMenus\AppRoleMenuUpdateController::class)->name('lazy.app-role-menus.update');

Route::get('/app-role-route/{id}/detail', App\Http\Controllers\AppRoleRoutes\AppRoleRouteDetailController::class)->name('lazy.app-role-routes.detail');

Route::post('/app-role-route/store', App\Http\Controllers\AppRoleRoutes\AppRoleRouteStoreController::class)->name('lazy.app-role-routes.store');

Route::get('/app-role-route/list', App\Http\Controllers\AppRoleRoutes\AppRoleRouteListController::class)->name('lazy.app-role-routes.list');

Route::delete('/app-role-route/{id}/delete', App\Http\Controllers\AppRoleRoutes\AppRoleRouteDeleteController::class)->name('lazy.app-role-routes.delete');

Route::put('/app-role-route/{id}/update', App\Http\Controllers\AppRoleRoutes\AppRoleRouteUpdateController::class)->name('lazy.app-role-routes.update');

Route::get('/app-route/{name}/detail', App\Http\Controllers\AppRoutes\AppRouteDetailController::class)->name('lazy.app-routes.detail');

Route::post('/app-route/store', App\Http\Controllers\AppRoutes\AppRouteStoreController::class)->name('lazy.app-routes.store');

Route::get('/app-route/list', App\Http\Controllers\AppRoutes\AppRouteListController::class)->name('lazy.app-routes.list');

Route::delete('/app-route/{name}/delete', App\Http\Controllers\AppRoutes\AppRouteDeleteController::class)->name('lazy.app-routes.delete');

Route::put('/app-route/{name}/update', App\Http\Controllers\AppRoutes\AppRouteUpdateController::class)->name('lazy.app-routes.update');

Route::get('/app-setting/{id}/detail', App\Http\Controllers\AppSettings\AppSettingDetailController::class)->name('lazy.app-settings.detail');

Route::post('/app-setting/store', App\Http\Controllers\AppSettings\AppSettingStoreController::class)->name('lazy.app-settings.store');

Route::get('/app-setting/list', App\Http\Controllers\AppSettings\AppSettingListController::class)->name('lazy.app-settings.list');

Route::delete('/app-setting/{id}/delete', App\Http\Controllers\AppSettings\AppSettingDeleteController::class)->name('lazy.app-settings.delete');

Route::put('/app-setting/{id}/update', App\Http\Controllers\AppSettings\AppSettingUpdateController::class)->name('lazy.app-settings.update');
...
Route::get('/failed-job/{uuid}/detail', App\Http\Controllers\FailedJobs\FailedJobDetailController::class)->name('lazy.failed-jobs.detail');

Route::post('/failed-job/store', App\Http\Controllers\FailedJobs\FailedJobStoreController::class)->name('lazy.failed-jobs.store');

Route::get('/failed-job/list', App\Http\Controllers\FailedJobs\FailedJobListController::class)->name('lazy.failed-jobs.list');

Route::delete('/failed-job/{uuid}/delete', App\Http\Controllers\FailedJobs\FailedJobDeleteController::class)->name('lazy.failed-jobs.delete');

Route::put('/failed-job/{uuid}/update', App\Http\Controllers\FailedJobs\FailedJobUpdateController::class)->name('lazy.failed-jobs.update');

Route::get('/font-icon-type/{name}/detail', App\Http\Controllers\FontIconTypes\FontIconTypeDetailController::class)->name('lazy.font-icon-types.detail');

Route::post('/font-icon-type/store', App\Http\Controllers\FontIconTypes\FontIconTypeStoreController::class)->name('lazy.font-icon-types.store');

Route::get('/font-icon-type/list', App\Http\Controllers\FontIconTypes\FontIconTypeListController::class)->name('lazy.font-icon-types.list');

Route::delete('/font-icon-type/{name}/delete', App\Http\Controllers\FontIconTypes\FontIconTypeDeleteController::class)->name('lazy.font-icon-types.delete');

Route::put('/font-icon-type/{name}/update', App\Http\Controllers\FontIconTypes\FontIconTypeUpdateController::class)->name('lazy.font-icon-types.update');

Route::get('/font-icon/{id}/detail', App\Http\Controllers\FontIcons\FontIconDetailController::class)->name('lazy.font-icons.detail');

Route::post('/font-icon/store', App\Http\Controllers\FontIcons\FontIconStoreController::class)->name('lazy.font-icons.store');

Route::get('/font-icon/list', App\Http\Controllers\FontIcons\FontIconListController::class)->name('lazy.font-icons.list');

Route::delete('/font-icon/{id}/delete', App\Http\Controllers\FontIcons\FontIconDeleteController::class)->name('lazy.font-icons.delete');

Route::put('/font-icon/{id}/update', App\Http\Controllers\FontIcons\FontIconUpdateController::class)->name('lazy.font-icons.update');
...
Route::get('/migration/{id}/detail', App\Http\Controllers\Migrations\MigrationDetailController::class)->name('lazy.migrations.detail');

Route::post('/migration/store', App\Http\Controllers\Migrations\MigrationStoreController::class)->name('lazy.migrations.store');

Route::get('/migration/list', App\Http\Controllers\Migrations\MigrationListController::class)->name('lazy.migrations.list');

Route::delete('/migration/{id}/delete', App\Http\Controllers\Migrations\MigrationDeleteController::class)->name('lazy.migrations.delete');

Route::put('/migration/{id}/update', App\Http\Controllers\Migrations\MigrationUpdateController::class)->name('lazy.migrations.update');
...
Route::get('/permission/{id}/detail', App\Http\Controllers\Permissions\PermissionDetailController::class)->name('lazy.permissions.detail');

Route::post('/permission/store', App\Http\Controllers\Permissions\PermissionStoreController::class)->name('lazy.permissions.store');

Route::get('/permission/list', App\Http\Controllers\Permissions\PermissionListController::class)->name('lazy.permissions.list');

Route::delete('/permission/{id}/delete', App\Http\Controllers\Permissions\PermissionDeleteController::class)->name('lazy.permissions.delete');

Route::put('/permission/{id}/update', App\Http\Controllers\Permissions\PermissionUpdateController::class)->name('lazy.permissions.update');

Route::get('/personal-access-token/{token}/detail', App\Http\Controllers\PersonalAccessTokens\PersonalAccessTokenDetailController::class)->name('lazy.personal-access-tokens.detail');

Route::post('/personal-access-token/store', App\Http\Controllers\PersonalAccessTokens\PersonalAccessTokenStoreController::class)->name('lazy.personal-access-tokens.store');

Route::get('/personal-access-token/list', App\Http\Controllers\PersonalAccessTokens\PersonalAccessTokenListController::class)->name('lazy.personal-access-tokens.list');

Route::delete('/personal-access-token/{token}/delete', App\Http\Controllers\PersonalAccessTokens\PersonalAccessTokenDeleteController::class)->name('lazy.personal-access-tokens.delete');

Route::put('/personal-access-token/{token}/update', App\Http\Controllers\PersonalAccessTokens\PersonalAccessTokenUpdateController::class)->name('lazy.personal-access-tokens.update');
...
Route::get('/role-permission/{id}/detail', App\Http\Controllers\RolePermissions\RolePermissionDetailController::class)->name('lazy.role-permissions.detail');

Route::post('/role-permission/store', App\Http\Controllers\RolePermissions\RolePermissionStoreController::class)->name('lazy.role-permissions.store');

Route::get('/role-permission/list', App\Http\Controllers\RolePermissions\RolePermissionListController::class)->name('lazy.role-permissions.list');

Route::delete('/role-permission/{id}/delete', App\Http\Controllers\RolePermissions\RolePermissionDeleteController::class)->name('lazy.role-permissions.delete');

Route::put('/role-permission/{id}/update', App\Http\Controllers\RolePermissions\RolePermissionUpdateController::class)->name('lazy.role-permissions.update');
...
Route::get('/user-activity/{id}/detail', App\Http\Controllers\UserActivities\UserActivityDetailController::class)->name('lazy.user-activities.detail');

Route::post('/user-activity/store', App\Http\Controllers\UserActivities\UserActivityStoreController::class)->name('lazy.user-activities.store');

Route::get('/user-activity/list', App\Http\Controllers\UserActivities\UserActivityListController::class)->name('lazy.user-activities.list');

Route::delete('/user-activity/{id}/delete', App\Http\Controllers\UserActivities\UserActivityDeleteController::class)->name('lazy.user-activities.delete');

Route::put('/user-activity/{id}/update', App\Http\Controllers\UserActivities\UserActivityUpdateController::class)->name('lazy.user-activities.update');
